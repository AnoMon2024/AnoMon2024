...
public:
    ...
    int cell_cnt[LINE_CNT] = {80000, 20000, 10000, 5000};
...
public:
    ...
    MicroSketch(int memory) {
        ...
        if (RECORD_DELAY)
            cell_sketch = new CellSketch(sketch_memory);
    }
